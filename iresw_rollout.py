...
from skimo.rolf.utils import Logger, Info, Every
from skimo.rolf.algorithms.rollout import Rollout, RolloutRunner


class IreswRolloutRunner(RolloutRunner):
                ...
                while not done and skill_len < cfg.rolf.skill_horizon:
                    ...
                    if step < cfg.rolf.warm_up_step:
                        ac, state_next_ll = skill_agent.act(
                            ob, state_ll, cond=meta_ac, is_train=False, warmup=True
                        )
                    else:
                        ac, state_next_ll = skill_agent.act(
